    ...
    <div>
      ...
      <EulaWrapper>
        <h2>
          ...
          <span class="app_name">Music Note</span>
        </h2>
        <p>
          This End-User License Agreement ("EULA") is a legal agreement between
          you and <span class="company_name">Tyler Norbury</span>. Our EULA was
          created by <a href="https://www.eulatemplate.com">EULA Template</a>{" "}
          for <span class="app_name">Music Note</span>.
        </p>
        <p>
          This EULA agreement governs your acquisition and use of our{" "}
          <span class="app_name">Music Note</span> software ("Software")
          directly from <span class="company_name">Tyler Norbury</span> or
          indirectly through a <span class="company_name">Tyler Norbury</span>{" "}
          authorized reseller or distributor (a "Reseller"). Our Privacy Policy
          was created by{" "}
        ...
        <p>
          ...
          <span class="app_name">Music Note</span> software. It provides a
          license to use the <span class="app_name">Music Note</span> software
          and contains warranty information and liability disclaimers.
        </p>
        <p>
          If you register for a free trial of the{" "}
          <span class="app_name">Music Note</span> software, this EULA agreement
          will also govern that trial. By clicking "accept" or installing and/or
          using the <span class="app_name">Music Note</span> software, you are
        ...
        <p>
          ...
          <span class="company_name">Tyler Norbury</span> herewith regardless of
          whether other software is referred to or described herein. The terms
          also apply to any <span class="company_name">Tyler Norbury</span>{" "}
        ...
        <p>
          <span class="company_name">Tyler Norbury</span> hereby grants you a
          personal, non-transferable, non-exclusive licence to use the{" "}
          <span class="app_name">Music Note</span> software on your devices in
          accordance with the terms of this EULA agreement.
        </p>

        <p>
          You are permitted to load the <span class="app_name">Music Note</span>{" "}
          ...
          minimum requirements of the <span class="app_name">Music Note</span>{" "}
          software.
        </p>
        ...
        <ul>
          ...
          <li>
            ...
            <span class="company_name">Tyler Norbury</span> considers is a
        ...
        <p>
          <span class="company_name">Tyler Norbury</span> shall at all times
          retain ownership of the Software as originally downloaded by you and
          all subsequent downloads of the Software by you. The Software (and the
          ...
          <span class="company_name">Tyler Norbury</span>.
        </p>

        <p>
          <span class="company_name">Tyler Norbury</span> reserves the right to
