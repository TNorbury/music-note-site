...
export type FeaturesPageQuery = { features: { edges: Array<{ node: (
        Pick<MarkdownRemark, 'html'>
        & { frontmatter?: Maybe<Pick<MarkdownRemarkFrontmatter, 'feature' | 'label'>> }
      ) }> }, images: { edges: Array<{ node: (
        Pick<File, 'name'>
...
export type PrivacyPageQuery = { markdownRemark?: Maybe<Pick<MarkdownRemark, 'html'>> };
